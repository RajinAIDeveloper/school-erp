...
urlpatterns = [
    ...
    path("rounds/<int:pk>/report/", views.report, name="report"),
    path("classes/<int:pk>/assessments/", views.assessments, name="assessments"),
    path("classes/<int:pk>/merit/", views.merit, name="merit"),
    path("classes/<int:pk>/enrol/", views.enrol, name="enrol"),
    path("assessments/<int:pk>/", views.sitting, name="sitting"),
