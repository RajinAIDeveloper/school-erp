...
urlpatterns = [
    ...
    path("transcripts/", views.transcript_queue, name="transcripts"),
    path("transcripts/student/<int:pk>/", views.student_transcripts, name="student_transcripts"),
    path("transcripts/<int:pk>/pdf/", views.transcript_download, name="transcript_pdf"),
    path("transcripts/verify/<uuid:code>/", views.transcript_verify, name="transcript_verify"),
