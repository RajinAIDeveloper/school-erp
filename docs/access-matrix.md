...
report-card verification page (which names no child and shows no mark), and the health probe.
A test asserts that list, so a view that forgets its permission decorator cannot quietly
join it.

| URL | View | Permission | Administrator | Principal | Accountant | Teacher | Staff | Student | Guardian |
|---|---|---|:-:|:-:|:-:|:-:|:-:|:-:|:-:|
...
| /attendance/leave/ | attendance:leave_list | `attendance.view_leaverequest` | Y | Y | . | Y | Y | . | . |
| /attendance/leave/<int:pk>/review/ | attendance:leave_review | `attendance.change_leaverequest` | Y | Y | . | . | . | . | . |
...
| /attendance/student/<int:pk>/ | attendance:student_history | `attendance.view_studentattendance` | Y | Y | . | Y | . | . | . |
| /attendance/summary/ | attendance:daily_summary | `attendance.view_studentattendance` | Y | Y | . | Y | . | . | . |
...
| /employees/<int:pk>/ | employees:detail | `(sign-in only)` | o | o | o | o | o | o | o |
...
| /employees/documents/<int:pk>/ | employees:document | `(sign-in only)` | o | o | o | o | o | o | o |
...
| /exams/admit-cards.pdf | examinations:admit_cards | `examinations.view_exam` | Y | Y | . | Y | . | . | . |
...
| /exams/marks/ | examinations:marks | `examinations.view_mark` | Y | Y | . | Y | . | . | . |
...
| /exams/report-cards.pdf | examinations:report_cards | `examinations.view_mark` | Y | Y | . | Y | . | . | . |
| /exams/results/ | examinations:results | `examinations.view_mark` | Y | Y | . | Y | . | . | . |
...
| /exams/unlocks/ | examinations:unlocks | `examinations.view_mark` | Y | Y | . | Y | . | . | . |
...
| /fees/<int:pk>/ | fees:invoice_detail | `(sign-in only)` | o | o | o | o | o | o | o |
...
| /fees/receipts/<int:pk>.pdf | fees:receipt | `(sign-in only)` | o | o | o | o | o | o | o |
| /fees/reports/ | fees:report | `fees.view_feepayment` | Y | Y | Y | . | . | . | . |
| /fees/statement/<int:student_pk>/ | fees:statement | `(sign-in only)` | o | o | o | o | o | o | o |
...
| /reports/leave/ | reports:leave_register | `attendance.view_leaverequest` | Y | Y | . | Y | Y | . | . |
...
| /reports/teacher-load/ | reports:teacher_load | `timetable.view_routineslot` | Y | Y | . | Y | Y | Y | Y |
| /routine/ | timetable:routine | `timetable.view_routineslot` | Y | Y | . | Y | Y | Y | Y |
| /routine/edit/ | timetable:grid_edit | `timetable.change_routineslot` | Y | Y | . | . | . | . | . |
| /routine/free-teachers.json | timetable:free_teachers | `timetable.view_routineslot` | Y | Y | . | Y | Y | Y | Y |
...
| /routine/utilisation/ | timetable:utilisation | `timetable.view_routineslot` | Y | Y | . | Y | Y | Y | Y |
...
| /students/<int:pk>/ | students:detail | `(sign-in only)` | o | o | o | o | o | o | o |
...
| /users/provision/credentials.csv | users:credentials_csv | `users.add_user` | Y | . | . | . | . | . | . |
