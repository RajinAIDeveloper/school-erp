...
def test_desktop_mobile_navigation_and_real_forms(live_server,erp,settings):
    ...
    with playwright.sync_playwright() as p:
        ...
        page.route("**/static/**",lambda route:route.fulfill(path=str(root/"static"/route.request.url.split("/static/",1)[1])))
        page.reload()
        ...
        assert page.locator("aside").evaluate("(e)=>getComputedStyle(e).backgroundColor")=="rgb(15, 23, 43)" or page.locator("aside").evaluate("(e)=>getComputedStyle(e).backgroundColor")!="rgba(0, 0, 0, 0)"
